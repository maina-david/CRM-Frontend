      ...
      >
        ...
        >
          ...
          >
            <div class="border-b">
              <div class="p-3">
                <h2 class="font-medium text-blue-400">Team Users</h2>
            ...
            <slot>
              <div class="flex flex-row">
                ...
                <div class="mx-6">
                  ...
                  <ViewteamUsers
                    :tableHead="teamUsersTableHead"
                    :tableData="currentTeamMembers"
                  />
                </div>
              </div>
            </slot>
...
import ViewteamUsers from "@/components/tables/WorkflowTables/ViewteamUsers.vue";
...
export default {
  ...
  data() {
    return {
      newHelpDeskUser: "",
      teamUsersTableHead: ["name", "email", "phone number", "actions"],
      currentTeamMembers: [
        {
          name: "Jane Doe",
          email: "janedoe@gmail.com",
          phone_number: "+254 789 456 858",
        },
      ],
    };
  },
