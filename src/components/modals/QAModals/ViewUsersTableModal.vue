            ...
            <div class="border-b">
              <div class="p-3">
                <h2 v-if="state == false" class="font-medium text-blue-400">
                  Users in this QA Team
                </h2>
                <h2 v-if="state == true" class="font-medium text-blue-400">
                  Supervisors in this QA Team
                </h2>
...
export default {
  ...
  updated() {
    this.team = this.currentQualityAssuranceTeam;
  },
  created() {
