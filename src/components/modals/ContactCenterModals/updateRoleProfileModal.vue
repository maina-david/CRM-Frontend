      ...
      >
        ...
        >
          ...
          >
            <div class="border-b">
              <div class="p-3">
                <h2 class="font-medium text-blue-400">Update Role Profile</h2>
            ...
            <slot>
              <div class="mt-5">
                ...
                <ActionButton
                  text="Update Role Profile"
                  class="mt-5"
                  @click.prevent="handleUpdateRoleProfile"
                />
              </div>
            </slot>
          </div>
...
export default {
  ...
  methods: {
    ...mapActions(["updateRoleProfile"]),
    handleUpdateRoleProfile() {
