<template>
  ...
  >
    ...
    <div class="flex justify-between">
      <div>
        <div>
          <router-link :to="{ name: 'LeadManagementFormBuilder' }">
            <button
      ...
      <div class="">
        <button
          @click="handleEditLeadManagementForm('Edit', form)"
  ...
  <CreateLeadForm :show="showFormModal" :state="state" />
</template>

<script>
import { ref } from "vue";
import CreateLeadForm from "@/components/modals/CRMModals/CreateLeadForm.vue";
...
export default {
  ...
  methods: {
    handleEditLeadManagementForm(state) {
      this.state = state;
