<template>
    ...
    >
      ...
      <tbody>
        ...
        >
          ...
          >
            <span
              v-if="data.assignedHelpDesk"
              class="bg-green-100 text-green-700 px-2 py-1"
              >{{ data.assignedHelpDesk }}</span
            >
            <span v-else class="bg-red-100 text-red-700 px-2 py-1"
              >No Help DeskAttached</span
            >
          </td>
          <td
            scope="row"
          ...
          >
            <div>
              <button
                @click="
                  showCreateEscalationLevelsModal =
                    !showCreateEscalationLevelsModal
                "
  ...
  <CreateEscalationLevelModal :show="showCreateEscalationLevelsModal" />
...
<script>
import { ref } from "vue";
import CreateEscalationLevelModal from "@/components/modals/CaseManagementModals/CreateEscalationLevelModal.vue";
...
export default {
  ...
  setup() {
    ...
    const showCreateEscalationLevelsModal = ref(false);
