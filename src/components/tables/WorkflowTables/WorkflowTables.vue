      ...
      <tbody>
        ...
        >
          ...
          >
            <div>
              <button
                @click="showCreateWorkflowModal = !showCreateWorkflowModal"
            ...
            <div>
              <router-link :to="{ name: 'WorkFlowDrawFlow' }">
                <button
                  class="font-medium text-xs text-center m-2 px-2 py-1 text-gray-500 rounded-sm hover:bg-lime-500 hover:text-white"
                >
                  Manage Workflow Flow
                </button>
              </router-link>
            </div>
            <div>
...
import CreateWorkflowModal from "@/components/modals/WorkflowManagementModals/CreateWorkflowModal.vue";
