      ...
      <tbody>
        ...
        >
          ...
          >
            <div>
              <button
                @click="showCreateTeamModal = !showCreateTeamModal"
            ...
            <div>
              <button
                @click="showTeamUsersModal = !showTeamUsersModal"
                class="font-medium text-xs text-center m-2 px-2 py-1 text-gray-500 rounded-sm hover:bg-lime-500 hover:text-white"
              >
                View Users
              </button>
            ...
            <div>
              <button
                @click="showAddTeamUsers = !showAddTeamUsers"
                class="font-medium text-xs text-center m-2 px-2 py-1 text-gray-500 rounded-sm hover:bg-lime-500 hover:text-white"
              >
                Add Users
              </button>
...
<script>
import { ref } from "vue";
import CreateTeamModal from "@/components/modals/WorkflowManagementModals/CreateTeamModal.vue";
import ViewUsersTableModal from "@/components/modals/WorkflowManagementModals/ViewUsersTableModal.vue";
import AddUsersToTeam from "@/components/modals/WorkflowManagementModals/AddUsersToTeam.vue";
