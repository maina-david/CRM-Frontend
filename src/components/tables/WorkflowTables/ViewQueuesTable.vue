    ...
    >
      ...
      <tbody v-if="state == false">
        ...
        >
          ...
          >
            <span
              @click="handleRemoveQualityAssuranceQueue(data)"
...
export default {
  ...
  updated() {
    this.teamQueues = this.tableData?.queues;
  },
  created() {
    this.teamQueues = this.tableData?.queues;
  },
  methods: {
    ...mapActions(["removeQueueFromQualityAssuranceTeam"]),
    handleRemoveQualityAssuranceQueue(data) {
      if (
        confirm(
        ...
        this.removeQueueFromQualityAssuranceTeam({
          team_id: this.tableData.id,
          queue_id: data.id,
