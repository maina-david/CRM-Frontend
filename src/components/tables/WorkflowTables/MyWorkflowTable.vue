<template>
  ...
  <ViewWorkFlowFormModal :show="showWorkFlowFormModal" />
</template>

<script>
import { ref } from "vue";

import ViewWorkFlowFormModal from "@/components/modals/WorkflowManagementModals/ViewWorkFlowFormModal.vue";
...
export default {
  ...
  setup() {
    const showWorkFlowFormModal = ref(false);
