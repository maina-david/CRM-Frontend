      ...
      <tbody>
        ...
        >
          ...
          <td
            ...
            class="py-2 px-3 font-medium text-xs text-gray-900 whitespace-nowrap dark:text-white"
          >
            <span v-if="data.role_profile?.name">{{
              data.role_profile?.name
            }}</span>
            <span v-else class="text-red-400">N/A</span>
          </td>
          <td
          ...
          >
            <div v-if="data.groups.length > 0">
              <span v-for="group in data.groups" :key="group.id">
                {{ group?.name }}
              </span>
            </div>
            <span v-else class="text-red-400">N/A</span>
          ...
          <td class="py-2 px-3">
            <button
              ...
              class="font-medium text-xs text-bg-gray-500 hover:text-red-600"
            >
              Deactivate User
            </button>
            <button
