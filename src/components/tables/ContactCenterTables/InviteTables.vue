<template>
  <div class="overflow-x-auto sm:rounded-lg p-1 mt-5">
    <div class="flex justify-between items-center">
      <div>
        <h1 class="text-lg font-semibold">Invites</h1>
      </div>
    </div>
    <hr
        ...
        >
          ...
          >
            <span
              ...
              class="rounded-sm m-2 p-1 text-white bg-orange-500 font-normal text-xs flex align-center w-max cursor-pointer active:bg-gray-300 transition duration-300 ease"
            >
              Pending
            </span>
            <span
          ...
          <td class="py-2 px-3">
            <button
              v-if="data.status == 'ACTIVE'"
              @click="revokeInvitation(data.id)"
            ...
            <button
              v-if="data.status == 'DEACTIVATED'"
              @click="reactivateInvitation(data.id)"
              class="font-medium text-xs text-bg-gray-500 hover:text-red-600"
            >
...
export default {
  ...
  methods: {
    ...mapActions(["revokeInvites", "reactivateInvites"]),
    revokeInvitation(id) {
      console.log("revoking", id);
      this.revokeInvites({ invitation_id: id });
    },
    reactivateInvitation(id) {
      console.log("reactivating", id);
      this.reactivateInvites({ invitation_id: id });
    },
  },
};
</script>
