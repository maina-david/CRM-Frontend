...
export default {
  methods: {
    ...mapActions(["removeAgent"]),
    handleRemoveAgent(data) {
      console.log("this is the agent data", data);
      console.log("this is the queue data", this.currentQueue);
      this.removeAgent({
        user_id: data.id,
        queue_id: JSON.parse(localStorage.getItem("current_queue_id")),
      });
    },
  },
  name: "UserTables",
