    ...
    >
      ...
      <tbody>
        ...
        >
          ...
          >
            <span
              @click="handleCall(data)"
              class="material-icons text-sm cursor-pointer hover:text-white hover:bg-lime-500 px-2 py-1"
              >call</span
            >
          </td>
        </tr>
...
export default {
  ...
  setup() {
    ...
    return { showInternalCallModal };
  },
  methods: {
    handleCall(data) {
      this.agentData = data;
      this.internalCall = !this.internalCall;
    },
  },
  components: {
    SearchBar,
