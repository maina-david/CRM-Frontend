...
export default {
  ...
  methods: {
    ...mapActions(["deleteSettingAudio"]),
    handleDeleteAudio(data) {
      if (confirm("Confirm Delete " + data.name + "?") == true) {
        console.log("delete audio");
        this.deleteSettingAudio({
          file_id: data.id,
        });
      } else {
        console.log("delete audio cancelled");
      }
    },
  },
};
