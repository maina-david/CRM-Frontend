<template>
  <div class="overflow-x-auto sm:rounded-lg p-1 mt-5">
    <div class="pt-4">
      <h1 class="font-semibold">Access Rights</h1>
      <hr
    ...
    >
      ...
      <tbody>
        ...
        >
          ...
          <td
            scope="row"
            class="py-2 px-3 font-medium text-xs text-gray-900 dark:text-white"
          >
            <p class="truncate flex-wrap">{{ data.access_description }}</p>
          </td>
        </tr>
      </tbody>
    </table>
