<template>
  ...
  <CreateEvaluationTeamModal :show="showCreateTeamModal" />
...
<script>
import { ref } from "vue";
import CreateEvaluationTeamModal from "@/components/modals/QAModals/CreateEvaluationTeamModal.vue";
