<template>
  <div class="overflow-x-auto sm:rounded-lg p-1 mt-5">
    <div class="pt-4 flex justify-between">
      <div>
        <h1 class="font-semibold text-lg">Agent Report</h1>
      </div>
    </div>
    <table
    ...
    >
      ...
      <tbody>
        ...
        <tr
          ...
          v-else
          v-for="data in Object.values(tableData)"
          :key="data"
        >
          <td
            v-for="tableContent in data"
            :key="tableContent"
            scope="row"
    ...
    >
      <span class="text-sm font-normal text-gray-500"
        ...
        <span class="font-semibold text-gray-900"
          >1- {{ Object.keys(tableData).length }}</span
        >
        of
        <span class="font-semibold text-gray-900">{{
...
export default {
  ...
  components: { ChatTranscriptModal },
  setup() {
