    ...
    >
      ...
      <tbody>
        ...
        >
          ...
          >
            <span
              class="rounded-sm m-2 px-2 py-1 text-red-600 bg-red-100 font-normal text-xs flex align-center w-max cursor-pointer active:bg-gray-300 transition duration-300 ease"
            >
              {{ data.priority }}
            </span>
          </td>
