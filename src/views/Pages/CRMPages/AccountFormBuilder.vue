...
export default {
  ...
  watch: {
    ...
    accountFormItems: function () {
      console.log("i am watching here");
      this.getPreviousPlayFieldData(JSON.stringify(this.accountFormItems));
      console.log("this is the form items", this.formItems);
    },
  },
  setup() {
    var plain_html = "";
