  ...
  <main>
    <div class="ml-12">
      <div class="border-b flex justify-between mt-10">
        <div>
          <h2 class="font-bold text-xl p-3">
            Review Interaction
            {{ qualityAssuranceReviewsById.interaction_reference }}
          </h2>
        </div>

        <div>
          <div v-if="qualityAssuranceReviewsById.channel === 'Voice'">
            <audio
              id="player"
              class="mb-5"
              controls="controls"
      ...
      <div class="bg-white p-2 mt-10">
        <CompletedReviewInteractionTable
          :interaction="qualityAssuranceReviewsById"
          :tableHead="teamTableHead"
          :tableData="qualityAssuranceReviewsById.evaluation.reviews"
        />
      </div>
    </div>
...
<script>
import CompletedReviewInteractionTable from "@/components/tables/QAManagementTables/CompletedReviewInteractionTable.vue";
...
export default {
  created() {
    this.audioURL =
      ...
      this.qualityAssuranceReviewsById.interaction_reference +
      ".wav";
    console.log(
      "this is the interaction data",
      this.qualityAssuranceReviewsById
    );
  },
  methods: {
