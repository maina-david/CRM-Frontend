<template>
  <div class="flex justify-between border-b mt-10">
    ...
    <div class="m-4 flex gap-3">
      <ActionButton
        text="Select Queues"
        @click="showSelectQueuesModal = !showSelectQueuesModals"
      />
  ...
  <div v-if="visual == 'graphic'">
    ...
    <div class="bg-white mt-5 p-3 mb-2 shadow-sm overflow-hidden">
      ...
      <BarChart :chartData="queueHoldTimeChartData" />
    </div>
    <div class="bg-white mt-5 p-3 mb-2 shadow-sm overflow-hidden">
      <div class="p-2 border-b">
        <h2 class="text-sm font-normal">MUTE TIME</h2>
      </div>
      <BarChart :chartData="queueMuteTimeChartData" />
    </div>
    <div class="bg-white mt-5 p-3 mb-2 shadow-sm overflow-hidden">
      <div class="p-2 border-b">
        <h2 class="text-sm font-normal">SERVICE LEVEL</h2>
      </div>
      <BarChart :chartData="queueServiceLevelChartData" />
    </div>
    <div class="bg-white mt-5 p-3 mb-2 shadow-sm overflow-hidden">
      <div class="p-2 border-b">
        <h2 class="text-sm font-normal">FIRST CALL</h2>
      </div>
      <BarChart :chartData="queueFirstCallChartData" />
    </div>
  </div>
  <div v-if="visual == 'tabular'">
    ...
    <div class="bg-white mt-5 p-3 mb-2 shadow-sm overflow-hidden">
      ...
      <AgentReportsTable
        :tableHead="queueHoldTimeChartData.labels"
        :tableData="queueHoldTimeChartData"
        :period="period"
      />
    </div>
    <div class="bg-white mt-5 p-3 mb-2 shadow-sm overflow-hidden">
      ...
      <AgentReportsTable
        :tableHead="queueMuteTimeChartData.labels"
        :tableData="queueMuteTimeChartData"
        :period="period"
      />
    </div>
    <div class="bg-white mt-5 p-3 mb-2 shadow-sm overflow-hidden">
      ...
      <AgentReportsTable
        :tableHead="queueFirstCallChartData.labels"
        :tableData="queueFirstCallChartData"
        :period="period"
      />
    </div>
    <div class="bg-white mt-5 p-3 mb-2 shadow-sm overflow-hidden">
